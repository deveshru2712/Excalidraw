...
const Tools = [
  { id: 1, icon: Pencil, tooltip: "Pencil", value: "pencil" as const },
  { id: 2, icon: "T", tooltip: "Text", value: "text" as const },
  { id: 3, icon: Eraser, tooltip: "Eraser", value: "eraser" as const },
];
